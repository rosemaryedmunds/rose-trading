---
title: "Lesson 5: Technical Analysis, #TheStrat & Saty's Framework"
phase: "Phase 4: Reading the Charts"
week: 5
---
...
**Green candle** = Close was ABOVE the open (bullish — price went up)
**Red candle** = Close was BELOW the open (bearish — price went down)
...
**Support** is a price level where buyers historically step in (a floor).
**Resistance** is a price level where sellers historically step in (a ceiling).
